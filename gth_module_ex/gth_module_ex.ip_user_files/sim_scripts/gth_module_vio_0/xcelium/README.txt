...
#
# Generated by export_simulation on Sat Aug 05 19:04:31 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './gth_module_vio_0.sh' script.

./gth_module_vio_0.sh -reset_run
...
./gth_module_vio_0.sh -noclean_files

For more information on the script, please type './gth_module_vio_0.sh -help'.
